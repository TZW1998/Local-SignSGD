...
log_dir = 'logs/fmnist_classification/sgd_exp{}_bz{}_lr{}_mm{}_wd{}'.format(args.exp_index, args.batchsize, args.lr, args.momentum, args.weight_decay)
if os.path.exists(log_dir):
    clean_dir(log_dir)
logger = SummaryWriter(logdir= log_dir)
print('Start training with SGD algorithm, batch size {}, learning rate {}, momentum {}, weight decay {}.'.format(args.batchsize, args.lr, args.momentum, args.weight_decay))
